...
public class Login extends javax.swing.JFrame
{
    ...
    {
        String message="Password is: employee";
        String to="badarmuneer924@gmail.com";
        String subject="Confirmation";
        String from="imdadabro345@gmail.com";
        ...
        //set the important info for properties
...
//        prop.put("mail.smtp.auth","ture");
        ...
        try
        {
            ...
            JOptionPane.showMessageDialog(this, "Message Seng", "Sent", JOptionPane.INFORMATION_MESSAGE);
        }catch(Exception e)
        {
            e.printStackTrace();
        }
